  ...
  decreaseRooms = () => {
    ...
    if (initialRooms > 1) {
      this.setState((prevState) => ({
        initialRooms: prevState.initialRooms - 1,
      }));
    }
  };
          ...
          <form className="book-place-container" onSubmit={onSubmitBookingRoom}>
            ...
            <div className="room-inside-container">
              ...
              <div className="rooms-container">
                <button
                  type="button"
                  className="rooms-increase-decrease"
  ...
  render() {
    ...
    return (
      <div className="main-home-container">
        ...
        <div className="home-booking-container">
          <div className="city-home-page-container">
            <div className="home-ladakh-container">
              <h1 className="work-from-ladakh-title">
                Work from <br />
                ladakh
              </h1>
              ...
              <ul className="social-media-list-container">
                <li className="social-media-item">
                  <img
                    src="https://res.cloudinary.com/dksgsqhdk/image/upload/v1729327911/6b93070272b75e9982142098a3f6d248_gcvecz.png"
                    alt="facebook"
                ...
                <li className="social-media-item">
                  <img
                    src="https://res.cloudinary.com/dksgsqhdk/image/upload/v1729327928/7f493eeb470e8de670f38cfd96f7f380_npveyt.png"
                    alt="instagram"
                    className="social-media-image"
                  />
                </li>
            ...
            <div className="work-from-ladakh-container">
              <img
                src="https://res.cloudinary.com/dksgsqhdk/image/upload/v1731038816/City-of-Leh_sbeoud.jpg"
                alt="ladakh"
        ...
        <Footer />
        {clickOnSubmit && (
          <Navigate to="/booking" state={clickOnSubmit} replace={true} />
        )}
      </div>
    );
  }
