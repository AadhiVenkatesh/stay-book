...
const profileOneDetails = {
  name: "Arjun Raghav",
  ratingImageUrl:
    "https://res.cloudinary.com/dksgsqhdk/image/upload/v1731046323/pngtree-five-star-rating-icon-png-image_4974126_pyoc0a.png",
  ...
  profileImageUrl:
    "https://res.cloudinary.com/dksgsqhdk/image/upload/v1731045438/thinking-young-man-profile-bw-portrait-profiblack-white-glasses-profilele-35451484_niau22.jpg",
};
...
const profileTwoDetails = {
  ...
  profileImageUrl:
    "https://res.cloudinary.com/dksgsqhdk/image/upload/v1731045438/thinking-young-man-profile-bw-portrait-profiblack-white-glasses-profilele-35451484_niau22.jpg",
  imageUrl:
    "https://res.cloudinary.com/dksgsqhdk/image/upload/v1731046713/Confluence_of_Indus_and_Zanskar_rivers_z4g5lv.jpg",
};
      ...
      <div className="discover-inside-container">
        <div className="sections-container">
          <div className="profile-image-name-container">
            <img
              src={profileOneDetails.profileImageUrl}
              alt="profile"
            ...
            <div className="rating-name-container">
              ...
              <img
                src={profileOneDetails.ratingImageUrl}
                alt="rating"
          ...
          <p>
            {slicedDesc} <span style={{ color: "blue" }}>readmore</span>
          </p>
        </div>
        <div className="section2-container">
          <img
            src={profileTwoDetails.imageUrl}
            alt="ladakh lake"
