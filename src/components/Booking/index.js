              ...
              <div className="confirmation-details-container">
                ...
                <div className="confirmation-inside-container">
                  ...
                  <div className="room-details-container">
                    <button
                      type="button"
                      className="rooms-increase-decrease-button"
                ...
                <div className="click-payment-confirmation-container">
                  <div className="arrow-button-container">
                    ...
                    <button type="submit" className="arrow-image-container">
                      <img
                        src="https://res.cloudinary.com/dksgsqhdk/image/upload/v1731150748/arrow-right-small-icon-2048x1365-cmy5bz89_t1atf5.png"
  ...
  render() {
    ...
    return (
      <div className="bookings-main-container">
        ...
        <BookingFooter />
        {clickOnPayment && (
          <Navigate to="/confirmation" state={clickOnPayment} replace={true} />
        )}
      </div>
    );
  }
